...
export const devProjects = [
  {
    ...
    name: "caferio",
    description:
      "Caferio is a beautifully designed static website for an online food ordering service. Built with HTML, CSS, and JavaScript, it features a clean UI, smooth animations, and a fully responsive layout. Perfect for showcasing restaurant menus and enhancing user experience with an elegant and intuitive design.",
    technologies: ["HTML", "CSS3", "Framer Motion"],
