...
export const devProjects = [
  ...
  {
    id: 1,
    name: "Headphone Slider",
    description:
      "An advanced 3D headphone product slider utilizing cutting-edge JavaScript animations and CSS techniques to deliver an immersive and interactive user experience.",
    technologies: ["JavaScript", "CSS3", "HTML5"],
    github: "https://github.com/vgor15/headphone-slider",
    demo: "https://vgor15.github.io/headphone-slider/",
    image: require(".//../../public/projects/headphones.png"),
    available: true,
  },
  {
    id: 2,
